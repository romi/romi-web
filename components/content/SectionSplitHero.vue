<template>
  <section
    ...
    :class="[
      'xl:sticky xl:top-[20vh] xl:min-h-[60vh]',
...
/* :deep(:is(h1)) { @apply !text-5xl; }
:deep(:is(h2)) { @apply !text-4xl; }
:deep(:is(h3)) { @apply !text-3xl; }
:deep(:is(h4)) { @apply !text-2xl; }
:deep(:is(h5)) { @apply !text-xl; }
